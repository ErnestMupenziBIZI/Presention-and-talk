...
plot(density(pool),col="red",main = "Distribution for ρ =0",xlim=c(-1,1),ylim=c(0,7),xlab ="r'")
...
plot(density(pool),col="red",main = "Distribution for ρ =0.5",xlim=c(-1,1),ylim=c(0,8),xlab ="r'")
...
plot(density(pool),col="red",main = "Distribution for ρ =0.8",xlim=c(0,1),ylim=c(0,16),xlab ="r'")
