...
#### DISTRIBUTION FOR ESTIMATORS "n=50"####
...
plot(density(pool),col="red",main = "Distribution for ρ =0",ylim=c(0,5),xlab ="r'")
...
#par(mfrow = c(2,2))
# hist(pool  ,probability = 1,breaks = 20,xlim = c(-0.5,1),xlab = "r' ",main = paste("Pooled Estimate for ρ =0.5"))
# hist(blind ,probability = 1,breaks = 20,xlim = c(-0.5,1),xlab = "r' ",main = paste("Blind Estimate for ρ=0.5"))
# hist(fisher,probability = 1,breaks = 20,xlim = c(-0.5,1),xlab = "r' ",main = paste("Fisher Estimate for ρ=0.5"))
# hist(op    ,probability = 1,breaks = 20,xlim = c(-0.5,1),xlab = "r' ",main = paste("OP Estimate for ρ=0.5"))

plot(density(pool),col="red",main = "Distribution for ρ =0.5",ylim=c(0,5),xlab ="r'")
...
#LCL<- (94/(qchisq(0.7,2*k-6)))*var(estimeted corr) #k=50

#par(mfrow = c(2,2))
# hist(pool  ,probability = 1,breaks = 10,xlim = c(0,1),xlab = "r' ",main = paste("Pooled Estimate for ρ =0.8"))
# hist(blind ,probability = 1,breaks = 10,xlim = c(0,1),xlab = "r' ",main = paste("Blind Estimate for ρ=0.8"))
# hist(fisher,probability = 1,breaks = 10,xlim = c(0,1),xlab = "r' ",main = paste("Fisher Estimate for ρ=0.8"))
# hist(op    ,probability = 1,breaks = 10,xlim = c(0,1),xlab = "r' ",main = paste("OP Estimate for ρ=0.8"))

plot(density(pool),col="red",main = "Distribution for ρ =0.8",ylim=c(0,8),xlab ="r'")
