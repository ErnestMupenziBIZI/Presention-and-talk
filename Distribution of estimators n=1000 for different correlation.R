...
par(mfrow = c(2,2))
# hist(pool  ,probability = 1,breaks = 5,xlim = c(-0.5,1),xlab = "r' ",main = paste("Pooled Estimate for ρ =0"))
# hist(blind ,probability = 1,breaks = 5,xlim = c(-0.5,1),xlab = "r' ",main = paste("Blind Estimate for ρ=0"))
# hist(fisher,probability = 1,breaks = 5,xlim = c(-0.5,1),xlab = "r' ",main = paste("Fisher Estimate for ρ=0"))
# hist(op    ,probability = 1,breaks = 5,xlim = c(-0.5,1),xlab = "r' ",main = paste("OP Estimate for ρ=0"))

plot(density(pool),col="red",main = "Distribution for ρ =0",xlim=c(-0.5,1),ylim=c(0,12),xlab ="r'")
...
#par(mfrow = c(2,2))
# hist(pool  ,probability = 1,breaks = 20,xlim = c(0,1),xlab = "r' ",main = paste("Pooled Estimate for ρ =0.5"))
# hist(blind ,probability = 1,breaks = 20,xlim = c(0,1),xlab = "r' ",main = paste("Blind Estimate for ρ=0.5"))
# hist(fisher,probability = 1,breaks = 20,xlim = c(0,1),xlab = "r' ",main = paste("Fisher Estimate for ρ=0.5"))
# hist(op    ,probability = 1,breaks = 20,xlim = c(0,1),xlab = "r' ",main = paste("OP Estimate for ρ=0.5"))

plot(density(pool),col="red",main = "Distribution for ρ =0.5",xlim=c(0,1),ylim=c(0,20),xlab ="r'")
...
#par(mfrow = c(2,2))
# hist(pool  ,probability = 1,breaks = 10,xlim = c(0.5,1),xlab = "r' ",main = paste("Pooled Estimate for ρ =0.8"))
# hist(blind ,probability = 1,breaks = 10,xlim = c(0.5,1),xlab = "r' ",main = paste("Blind Estimate for ρ=0.8"))
# hist(fisher,probability = 1,breaks = 10,xlim = c(0.5,1),xlab = "r' ",main = paste("Fisher Estimate for ρ=0.8"))
# hist(op    ,probability = 1,breaks = 10,xlim = c(0.5,1),xlab = "r' ",main = paste("OP Estimate for ρ=0.8"))

plot(density(pool),col="red",main = "Distribution for ρ =0.8",xlim=c(0.5,1),ylim=c(0,40),xlab ="r'")
